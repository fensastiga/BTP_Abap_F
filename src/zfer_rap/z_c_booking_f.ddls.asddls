...
define view entity Z_C_BOOKING_F as projection on z_r_booking_f
{
  key BookingUUID,
      TravelUUID,
      ...
      /* Associations */
      _BookingStatus,
      _BookingSupplement: redirected to composition child z_c_book_suppl_f,
      _Carrier,
      _Connection,
      _Customer,
      _Travel            : redirected to parent Z_C_TRAVEL_F
}
