CLASS zcl_carga_biblioteca_fer DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_carga_biblioteca_fer IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    data: lt_acc_categ type table of ztb_acc_categ_f,
          lt_catego    type table of ztb_catego_f,
          lt_clientes  type table of ztb_clientes_f,
          lt_clnts_lib type table of ztb_clnts_lib_f,
          lt_libros    type table of ztb_libros_f.
...
******** ztb_acc_categ_f ********
    ...
    delete from ztb_acc_categ_f.
    insert ztb_acc_categ_f from table @lt_acc_categ.
...
******** ztb_catego_f ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_catego_f.
    insert ztb_catego_f from table @lt_catego.
...
******** ztb_clientes_f ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clientes_f.
    insert ztb_clientes_f from table @lt_clientes.
...
******** ztb_clnts_lib_f
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clnts_lib_f.
    insert ztb_clnts_lib_f from table @lt_clnts_lib.
...
******** ztb_libros_f ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_libros_f.
    insert ztb_libros_f from table @lt_libros.
